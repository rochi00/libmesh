...
// The device Hilbert-projection system: storage access helpers and the
// orchestration tying the mesh/dof mirrors, the assembly kernels, and
// the PETSc solve together.
