...
// Device mirror of MeshBase connectivity: element node ids, node
// coordinates, and lookup tables built on demand from the host mesh and
// stored as Kokkos views.
