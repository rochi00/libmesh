...
// Lagrange shape functions and derivatives for the simplex topologies
// (triangles and tets), as device-inlinable functions shared between
// the host FE classes and Kokkos kernels.
