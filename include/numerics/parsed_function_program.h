...
// A flat, device-interpretable compilation of fparser bytecode:
// ParsedFunctionProgram translates a parsed expression into opcode and
// operand arrays that a Kokkos kernel can evaluate without host calls.
